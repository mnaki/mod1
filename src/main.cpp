...
int	main(int ac, char **av)
{
	...
	map.draw_cone(map.width / 4, map.height / 1 + 20, map.width / 8, 300 , false);
	map.draw_cone(map.width / 4, map.height / 2 + 20, map.width / 8, 300 , false);
	map.draw_cone(map.width / 4, map.height / 3 + 20, map.width / 8, 200 , true);
	// map.elevate_rect(0, 0, map.width, map.height, 400);
	map.draw_cone(map.width / 8, map.height / 2, 100, 30, false);
	map.viscosity = 0;
